...
maintained. The library has had a number of fixes added to it and has been rewritten in TypeScript.
...
```bash
npm install @shopfront/react-toggle
```
...
```javascript
import "@shopfront/react-toggle/style.css" // for ES6 modules
// or
require("@shopfront/react-toggle/style.css") // for CommonJS
```
